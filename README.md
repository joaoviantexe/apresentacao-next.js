...
- Aluno: [João Carlos Viana Teixeira](https://github.com/joaoviantexe)
- Docente: [Samara Lima de Souza](http://lattes.cnpq.br/4144652138881511)
- Instituição de Ensino: Universidade da Amazônia (UNAMA)

# 📜 Fontes Utilizadas
- https://nextjs.org/

# 🛠️ Materiais de Produção
- Documento: Canva
- Repositório: GitHub
